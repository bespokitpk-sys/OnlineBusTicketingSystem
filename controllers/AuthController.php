...
class AuthController {
    public static function register() {
        ...
        header('Location: ' . BASE_URL . 'public/auth_router.php?action=verifyOTP');
        exit;
    }
    ...
    public static function forgotPassword() {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: ' . BASE_URL . 'public/auth_router.php?action=forgotPassword');
            exit;
        }
    ...
    public static function resetPassword() {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: ' . BASE_URL . 'public/auth_router.php?action=resetPassword&token=' . ($_GET['token'] ?? ''));
            exit;
        }
        ...
        if (empty($token) || empty($password)) {
            $_SESSION['error'] = 'Invalid request.';
            header('Location: ' . BASE_URL . 'public/auth_router.php?action=resetPassword&token=' . $token);
            exit;
        }
