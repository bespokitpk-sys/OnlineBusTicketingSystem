...
<nav>
    ...
    <div>
        ...
        <a href="manage_schedules.php">My Schedules</a>
...
<div class="dashboard">
    ...
    <?php else: ?>
        <div style="background: white; padding: 52px 40px; border-radius: 14px; text-align: center; box-shadow: 0 2px 10px rgba(15,28,51,0.08); border: 1px solid #e7edf5;">
            ...
            <a href="add_schedule.php" class="quick-btn primary" style="padding: 12px 24px; display: inline-flex;">Create Schedule</a>
        </div>
    <?php endif; ?>
</div>
...
<script>
    ...
    function fetchPassengerDetails(ticketId) {
        ...
        fetch('get_passenger_details.php', {
            method: 'POST',
