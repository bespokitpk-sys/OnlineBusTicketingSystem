    ...
    <div class="admin-section">
        ...
        <div class="admin-card">
            ...
            <div class="card-body">
                ...
                <div class="btn-group">
                    <a href="add_bus.php" class="btn btn-primary">Add Bus</a>
                    <a href="manage_buses.php" class="btn btn-secondary">View All</a>
                </div>
            </div>
        </div>
        ...
        <div class="admin-card">
            ...
            <div class="card-body">
                ...
                <div class="btn-group">
                    <a href="add_operator.php" class="btn btn-primary">Create Operator</a>
        ...
        <div class="admin-card">
            ...
            <div class="card-body">
                ...
                <div class="btn-group">
                    <a href="manage_schedules.php" class="btn btn-secondary">View Schedules</a>
                </div>
            </div>
        </div>
        ...
        <div class="admin-card">
            ...
            <div class="card-body">
                ...
                <div class="btn-group">
                    <a href="manage_tickets.php" class="btn btn-secondary">View Tickets</a>
                </div>
            </div>
        </div>
