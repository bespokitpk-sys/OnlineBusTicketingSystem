...
<div class="form-container">
    ...
    <form method="POST">
        ...
        <div class="btn-group">
            ...
            <a href="manage_buses.php" style="padding: 12px 24px; background: #6c757d; color: white; text-decoration: none; border-radius: 6px; text-align: center; transition: all 0.3s; display: flex; align-items: center; justify-content: center;">Cancel</a>
        </div>
    </form>
</div>
